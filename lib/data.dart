...
List<AnimalInfo> animallist = [
  AnimalInfo(
      ...
      name: 'Crab',
      color: Colors.red,
      iconImage: 'images/c_crab.png',
      description: "Crab don't have brain as their nervous system ",
      paragraph:
          "A crab is a sea creature with a flat round body covered by a shell, "
  ...
  AnimalInfo(
      ...
      name: 'Elephant',
      color: Colors.grey,
      iconImage: 'images/c_elephant.png',
  ...
  AnimalInfo(
      ...
      images: [
        'https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.cdc.gov%2Fcoronavirus%2F2019-ncov%2Fdaily-life-coping%2Fanimals.html&psig=AOvVaw2tyICxdtykNPDiPMRdnHdi&ust=1609860784022000&source=images&cd=vfe&ved=0CAIQjRxqFwoTCMi1ovTMgu4CFQAAAAAdAAAAABAO'
      ],
  ...
  AnimalInfo(
      ...
      images: [],
      lifespan: " 1 – 2 years",
      speed: "4.0 km in 3.5 h"),
  AnimalInfo(
      position: 7,
      name: 'Blue bird',
      color: Colors.lightBlue,
      iconImage: 'images/c_bluebird.png',
      description: "Bluebirds are loved by gardeners for their insect control "
          "capabilities.",
      paragraph:
          "A bluebird is usually perceived as a symbol of joy and happiness that are expecting you in the future. If this bird has appeared in your life, it will remind you of all the beauty of the nature around you.",
      images: [
